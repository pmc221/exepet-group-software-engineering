...
urlpatterns = [
    ...
    path('api/get_datetime_value/', views.get_datetime_value, name='get_datetime_value'),
    path('api/update_datetime_value/', views.update_datetime_value, name='update_datetime_value'),
    ...
    path('add-cherries', views.addCherries, name='add-cherries'),
]
